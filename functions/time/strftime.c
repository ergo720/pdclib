...
static int week_calc( const struct tm * timeptr, int wtype )
{
    ...
    if ( wtype <= E_MONDAY )
    {
        ...
        */
        div_t weeks = div_( timeptr->tm_yday, 7 );
        ...
        else
        {
            ...
            switch ( *format++ )
            {
                ...
                case 'C':
                {
                    ...
                    if ( rc < ( maxsize - 2 ) )
                    {
                        div_t period = div_( ( ( timeptr->tm_year + 1900 ) / 100 ), 10 );
                        s[rc++] = '0' + period.quot;
                        s[rc++] = '0' + period.rem;
                    }
                    else
                ...
                case 'd':
                {
                    ...
                    if ( rc < ( maxsize - 2 ) )
                    {
                        div_t day = div_( timeptr->tm_mday, 10 );
                        s[rc++] = '0' + day.quot;
                        s[rc++] = '0' + day.rem;
                    }
                    else
                ...
                case 'g':
                {
                    ...
                    if ( rc < ( maxsize - 2 ) )
                    {
                        div_t year = div_( week_calc( timeptr, E_ISO_YEAR ) % 100, 10 );
                        s[rc++] = '0' + year.quot;
                        s[rc++] = '0' + year.rem;
                    }
                    else
                ...
                case 'H':
                {
                    ...
                    if ( rc < ( maxsize - 2 ) )
                    {
                        div_t hour = div_( timeptr->tm_hour, 10 );
                        s[rc++] = '0' + hour.quot;
                        s[rc++] = '0' + hour.rem;
                    }
                    else
                ...
                case 'I':
                {
                    ...
                    if ( rc < ( maxsize - 2 ) )
                    {
                        div_t hour = div_( ( timeptr->tm_hour + 11 ) % 12 + 1, 10 );
                        s[rc++] = '0' + hour.quot;
                        s[rc++] = '0' + hour.rem;
                    }
                    else
                ...
                case 'j':
                {
                    ...
                    if ( rc < ( maxsize - 3 ) )
                    {
                        div_t yday = div_( timeptr->tm_yday + 1, 100 );
                        s[rc++] = '0' + yday.quot;
                        s[rc++] = '0' + yday.rem / 10;
                        s[rc++] = '0' + yday.rem % 10;
                    }
                ...
                case 'm':
                {
                    ...
                    if ( rc < ( maxsize - 2 ) )
                    {
                        div_t mon = div_( timeptr->tm_mon + 1, 10 );
                        s[rc++] = '0' + mon.quot;
                        s[rc++] = '0' + mon.rem;
                    }
                    else
                ...
                case 'M':
                {
                    ...
                    if ( rc < ( maxsize - 2 ) )
                    {
                        div_t min = div_( timeptr->tm_min, 10 );
                        s[rc++] = '0' + min.quot;
                        s[rc++] = '0' + min.rem;
                    }
                    else
                ...
                case 'S':
                {
                    ...
                    if ( rc < ( maxsize - 2 ) )
                    {
                        div_t sec = div_( timeptr->tm_sec, 10 );
                        s[rc++] = '0' + sec.quot;
                        s[rc++] = '0' + sec.rem;
                    }
                    else
                ...
                case 'U':
                {
                    ...
                    if ( rc < ( maxsize - 2 ) )
                    {
                        div_t week = div_( week_calc( timeptr, E_SUNDAY ), 10 );
                        s[rc++] = '0' + week.quot;
                        s[rc++] = '0' + week.rem;
                    }
                    else
                ...
                case 'V':
                {
                    ...
                    if ( rc < ( maxsize - 2 ) )
                    {
                        div_t week = div_( week_calc( timeptr, E_ISO_WEEK ), 10 );
                        s[rc++] = '0' + week.quot;
                        s[rc++] = '0' + week.rem;
                    }
                    else
                ...
                case 'W':
                {
                    ...
                    if ( rc < ( maxsize - 2 ) )
                    {
                        div_t week = div_( week_calc( timeptr, E_MONDAY ), 10 );
                        s[rc++] = '0' + week.quot;
                        s[rc++] = '0' + week.rem;
                    }
                    else
                ...
                case 'y':
                {
                    ...
                    if ( rc < ( maxsize - 2 ) )
                    {
                        div_t year = div_( ( timeptr->tm_year % 100 ), 10 );
                        s[rc++] = '0' + year.quot;
                        s[rc++] = '0' + year.rem;
                    }
                    else
